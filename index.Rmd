...
* … éventuellement démarrer la collecte et l'évaluation des données (selon le niveau des groupes)
...
Il nous fait maintenant rouver de vrais jeux de données correspondants à travers une phase de **collecte des données**. 
